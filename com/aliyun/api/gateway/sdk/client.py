...
class DefaultClient:
    ...
    def build_headers(self, request=None):
        ...
        if constant.X_CA_STAGE in header_params \
                and header_params[constant.X_CA_STAGE]:
            headers[constant.X_CA_STAGE] = header_params[constant.X_CA_STAGE]

        if constant.X_CA_REQUEST_MODE in header_params \
                and header_params[constant.X_CA_REQUEST_MODE]:
            headers[constant.X_CA_REQUEST_MODE] = header_params[constant.X_CA_REQUEST_MODE]
